...
def submit():
	...
	for super_population in param_super_population:
		...
		if gen_test_data:
			input_merge_file="/cvar/jhlab/snpsnap/data/step1/production_v2_QC_test/{super_population}/plink_merge_file.txt".format(super_population=super_population)
		else:
			input_merge_file="/cvar/jhlab/snpsnap/data/step1/production_v2_QC_full/{super_population}/plink_merge_file.txt".format(super_population=super_population)
		with open(input_merge_file, 'w') as f:
			for chromosome in param_chromosome: # **LOOPING OVER CHROMOSOME**#
				if gen_test_data:
					line2write="/cvar/jhlab/snpsnap/data/step1/production_v2_QC_test/{super_population}/ALL.{chromosome}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes".format(super_population=super_population, chromosome=chromosome) # OBS: this is the prefix needed in PLINK
				else:
					line2write="/cvar/jhlab/snpsnap/data/step1/production_v2_QC_full/{super_population}/ALL.{chromosome}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes".format(super_population=super_population, chromosome=chromosome) # OBS: this is the prefix needed in PLINK
				f.write(line2write+"\n")
