...
def submit():
	...
	for super_population in param_super_population:
		...
		input_prefix="/cvar/jhlab/snpsnap/data/production_v2_chrX_standalone-altQC/step1/2_QCbed_full/{super_population}/ALL.{chromosome}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes".format(super_population=super_population, chromosome="chrX")
		...
		input_bim = input_prefix + ".bim" # OBS:new
...
###################################### SETUP logging ######################################
current_script_name = os.path.basename(__file__).replace('.py','')
log_dir = "/cvar/jhlab/snpsnap/logs_pipeline/production_v2_chrX_standalone-altQC/step1_get_duplicates_merge" 
